 ...
 * @param *cls
 */
static enum MHD_Result access_handler(void *cls, struct MHD_Connection *connection, const char *url, const char *method,
    ...
    *req_cls = NULL;
    ...
    if (0 != strcmp(method, "GET")) {
        ...
        *req_cls = &aptr;
        ...
        //inital connection. TODO: need the JSON for this
        struct MHD_Response *response;
    }

    struct MHD_Response *response;
    response = MHD_create_response_from_buffer_static(strlen(PAGE_NOT_FOUND), PAGE_NOT_FOUND);
